      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" defaultValue="Alex Rivera" className="w-full bg-white/5 border border-white/10 rounded-twelve py-2 px-4 focus:border-primary focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm text-gray-400 mb-1">University / Bootcamp</label>
                  <input type="text" defaultValue="Stanford University" className="w-full bg-white/5 border border-white/10 rounded-twelve py-2 px-4 focus:border-primary focus:outline-none" />
                </div>
              </div>
              
              <div>
                <label className="block text-sm text-gray-400 mb-1">Bio</label>
                <textarea rows={4} className="w-full bg-white/5 border border-white/10 rounded-twelve py-2 px-4 focus:border-primary focus:outline-none" defaultValue="Passionate full stack developer looking for scalable systems."></textarea>
              </div>
            </div>
          </section>
          ...
          <section className="glass-card p-6 rounded-2xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="url" placeholder="https://linkedin.com/in/..." className="w-full bg-white/5 border border-white/10 rounded-twelve py-2 px-4 focus:border-primary focus:outline-none" />
              </div>
              <div>
                <label className="block text-sm text-gray-400 mb-1">GitHub Profile</label>
                <input type="url" placeholder="https://github.com/..." className="w-full bg-white/5 border border-white/10 rounded-twelve py-2 px-4 focus:border-primary focus:outline-none" />
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="space-y-6">
          <section className="glass-card p-6 rounded-2xl text-center">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary to-purple-500 mx-auto mb-4 border-4 border-dark"></div>
